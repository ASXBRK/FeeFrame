...
export const CORE_TASKS = [
  ...
  { id: 'soaReviewPresentation', label: 'SOA Review & Presentation', shortLabel: 'SOA review and presentation', adviserHours: 1.5, paraplannerHours: 1.0, adminHours: 0.5, externalAdviserHours: 1.5, externalParaplannerHours: 0, externalAdminHours: 0.5, defaultOn: true },
];
...
export const SERVICE_LINES: any[] = [];

export function formatStrategyList(strategies: any[], enabledStrategies: Record<string, boolean>): string {
